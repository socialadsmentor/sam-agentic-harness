...
1. Scaffold the context artifacts interactively (product, tech-stack, workflow, tracks)
...
1. Scaffold the context artifacts with existing-codebase detection
...
1. **Creation**: Initial setup via project scaffolding
