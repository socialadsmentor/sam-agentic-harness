...
- Test each layer in isolation using the dependency injection structure established here.
- Set up project structure and tooling that enforces these layer boundaries from the start.
